...
const manifestPattern = String.raw`^https?:\/\/(?!(?:[^\/]+\.)*pluto\.tv(?::\d+)?\/)(?!(?:[^\/]+\.)*(?:pplus\.paramount\.tech|paramount\.tech|paramountplus\.com|cbsaavideo\.com|cbsivideo\.com|cbs\.com)(?::\d+)?\/).+\.(?:m3u8|mpd)(?:\?.*)?$`;
...
const gatewayPattern = String.raw`^https?:\/\/(?:gss\.local|gss\.localhost(?::6170)?|127\.0\.0\.1(?::6170)?|localhost(?::6170)?)\/.*`;
